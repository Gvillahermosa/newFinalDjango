...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('studentLife_system', '0019_exceldata_admin_remarks_exceldata_variance'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloodType', models.CharField(choices=[('O-', 'O negative'), ('O+', 'O positive'), ('A-', 'A negative'), ('A+', 'A positive'), ('B-', 'B negative'), ('B+', 'B positive'), ('AB-', 'AB negative'), ('AB+', 'AB positive'), ('unknown', 'Unknown')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('intakeId', models.AutoField(primary_key=True, serialize=False)),
                ...
                ('individualProfileId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentLife_system.individualprofilebasicinfo')),
            ],
        ),
        migrations.CreateModel(
            name='OjtAssessment',
