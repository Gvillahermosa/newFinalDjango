...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='medicalv2.student')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='medicalv2.patient')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='medicalv2.patient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chest_xray', models.FileField(upload_to=medicalv2.models.MedicalRequirement.chest_xray_path)),
                ('cbc', models.FileField(upload_to=medicalv2.models.MedicalRequirement.cbc_path)),
                ('drug_test', models.FileField(upload_to=medicalv2.models.MedicalRequirement.drug_test_path)),
                ('stool_examination', models.FileField(upload_to=medicalv2.models.MedicalRequirement.stool_examination_path)),
                ('pwd_card', models.FileField(blank=True, null=True, upload_to=medicalv2.models.MedicalRequirement.pwd_id_card_path)),
                ('patient', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='medicalv2.patient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clearance', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='medicalv2.medicalclearance')),
            ],
        ),
        migrations.CreateModel(
            name='ObgyneHistory',
            fields=[
                ...
                ('examination', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='medicalv2.physicalexamination')),
            ],
        ),
        migrations.CreateModel(
            name='MedicalHistory',
